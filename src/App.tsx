          ...
          <div className="lg:col-span-7 space-y-8 text-left">
            <div className="space-y-4">
              ...
              <motion.p
                ...
                className="text-md md:text-lg text-[#2D2D2D]/85 leading-relaxed max-w-xl font-normal"
              >
      ...
      <section id="about" className="py-20 md:py-28 bg-[#F8F5F0]">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <div className="space-y-5 text-[#2D2D2D]/90 leading-relaxed font-normal text-base md:text-[17px]">
              <p>
                Welcome to your space for clarity. I am <strong className="font-semibold text-[#2D2D2D]">{COACH_INFO.name}</strong>. I believe that professional ascension should never demand the sacrifice of your mental wellbeing, core relationships, or personal alignment.
              </p>
              <p>
                {COACH_INFO.bioLong}
              </p>
              <p>
                We don't just explore theory—we rewrite the lifestyle structures and habits holding you back, giving you actual clarity and long-term agency.
              </p>
            </div>
      ...
      <section id="services" className="py-20 md:py-28 bg-white border-y border-[#EAE3D8]">
        <div className="max-w-7xl mx-auto px-6 md:px-12 text-center space-y-12">
          ...
          <div className="space-y-4 max-w-2xl mx-auto">
            ...
            <p className="text-[#2D2D2D]/80 text-sm md:text-base max-w-2xl mx-auto leading-relaxed">
      ...
      <section id="benefits" className="py-20 md:py-28 bg-[#F8F5F0]">
        <div className="max-w-7xl mx-auto px-6 md:px-12 gap-12 lg:gap-16 items-center grid grid-cols-1 lg:grid-cols-12">
          ...
          <div className="lg:col-span-5 space-y-6 text-left">
            ...
            <p className="text-[#2D2D2D]/85 text-base md:text-lg leading-relaxed font-normal">
              True alignment is more than motivation. It's about designing sustainable daily routines and habits that protect your mental clarity and professional energy.
            </p>
            <div className="pt-2">
              <button
                onClick={() => openBookingForService('')}
            ...
            {BENEFITS.map((benefit, bIdx) => (
              ...
              >
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-[#2D2D2D]/80 leading-relaxed font-normal">{benefit.description}</p>
                </div>
      ...
      <section id="process" className="py-20 md:py-28 bg-white border-y border-[#EAE3D8]">
        <div className="max-w-7xl mx-auto px-6 md:px-12 text-center space-y-16">
          ...
          <div className="space-y-4 max-w-2xl mx-auto">
            ...
            <div className="h-0.5 w-16 bg-[#7A8B72] mx-auto" />
            <p className="text-[#2D2D2D]/80 text-sm md:text-base max-w-2xl mx-auto leading-relaxed">
              A simple, structured path designed to focus on your progress and ensure a perfect fit from day one.
            </p>
          </div>
            ...
            {PROCESS_STEPS.map((step, idx) => (
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-[#2D2D2D]/85 leading-relaxed font-normal">{step.description}</p>
                </div>
      ...
      <section id="testimonials" className="py-20 md:py-28 bg-[#F8F5F0]">
        <div className="max-w-7xl mx-auto px-6 md:px-12 space-y-12 text-center">
          ...
          <div className="space-y-4 max-w-2xl mx-auto">
            ...
            <div className="h-0.5 w-16 bg-[#7A8B72] mx-auto" />
            <p className="text-[#2D2D2D]/80 text-sm md:text-base max-w-2xl mx-auto leading-relaxed">
              Stories and success insights straight from professionals, tech leaders, and creative directors.
            </p>
          </div>
      ...
      <section id="faq" className="py-20 md:py-28 bg-white border-y border-[#EAE3D8]">
        <div className="max-w-7xl mx-auto px-6 md:px-12 space-y-12">
          ...
          <div className="space-y-4 max-w-2xl mx-auto text-center">
            ...
            <div className="h-0.5 w-16 bg-[#7A8B72] mx-auto" />
            <p className="text-[#2D2D2D]/80 text-sm md:text-base max-w-2xl mx-auto leading-relaxed">
              Quick details on coaching programs, scheduling, and custom package structures.
            </p>
          </div>
      ...
      <section className="bg-[#EAE3D8]/40 border-b border-[#EAE3D8] py-12">
        <div className="max-w-5xl mx-auto px-6 md:px-12 items-center justify-between gap-8 flex flex-col md:flex-row">
          <div className="text-left space-y-1">
            ...
            <p className="text-sm text-[#2D2D2D]/75 max-w-md leading-relaxed font-normal">Weekly micro-lessons, reflective prompts, and priority VIP container openings delivered in premium, clutter-free text directly to your email inbox.</p>
          </div>
      ...
      <footer className="bg-white py-16 text-[#2D2D2D]" id="footer-section">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-4 gap-12 border-b border-[#F8F5F0] pb-12 text-left">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-[#2D2D2D]/70 leading-relaxed font-normal max-w-xs">
          ...
          <div className="space-y-4">
            ...
            <ul className="text-sm space-y-2.5 text-[#2D2D2D]/75 font-normal">
          ...
          <div className="space-y-4">
            ...
            <ul className="text-sm space-y-3.5 text-[#2D2D2D]/80 leading-relaxed font-normal">
