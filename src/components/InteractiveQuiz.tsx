          ...
          {step === 0 && (
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <p className="text-[#2D2D2D]/85 text-base leading-relaxed max-w-md mx-auto">
              ...
              <div className="space-y-3">
                {questions[step - 1].options.map((opt, oIdx) => (
                  <button
                    ...
                    className="w-full text-left px-6 py-4 rounded-xl border border-[#EAE3D8] bg-white hover:border-[#7A8B72] hover:bg-[#F8F5F0]/40 text-sm md:text-base font-medium text-[#2D2D2D]/90 hover:text-[#2D2D2D] transition-all cursor-pointer shadow-sm flex items-center justify-between group"
                  >
                    <span>{opt.label}</span>
          ...
          {step === questions.length + 1 && recommendedService && (
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-[#7A8B72] font-semibold">{recommendedService.duration} Container</p>
                <p className="text-base text-[#2D2D2D]/85 leading-relaxed max-w-md mx-auto mt-2">
              ...
              <div className="bg-white border border-[#EAE3D8] rounded-2xl p-5 text-left max-w-md mx-auto space-y-3 shadow-sm">
                <p className="text-xs text-[#2D2D2D]/60 uppercase font-mono tracking-wider font-semibold">Suggested Focus Benefits</p>
                <div className="grid grid-cols-1 gap-2 text-sm text-[#2D2D2D]/85">
                  {recommendedService.benefits.slice(0, 3).map((b, bI) => (
                    <div key={bI} className="flex items-start gap-2">
                      <span className="h-4 w-4 bg-[#7A8B72]/10 rounded-full flex items-center justify-center mt-0.5 shrink-0 text-xs text-[#7A8B72]">✔</span>
                      <span>{b}</span>
                    </div>
                  ))}
                </div>
