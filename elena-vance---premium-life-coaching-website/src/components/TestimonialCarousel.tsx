        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="flex-1 space-y-4">
              ...
              <blockquote className="font-serif text-base md:text-lg text-[#2D2D2D] leading-relaxed italic">
                "{current.quote}"
              </blockquote>

              <div className="not-italic space-y-0.5">
                <cite className="font-serif font-bold text-sm md:text-base text-[#2D2D2D]">
                  {current.name}
                </cite>
                <p className="text-xs text-[#7A8B72] font-semibold uppercase tracking-wider">
                  {current.role}
                </p>
              </div>
            </div>
